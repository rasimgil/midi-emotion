...
parser.add_argument('--n_layer', type=int, default=20 // 3,
                    help='number of total layers')
parser.add_argument('--n_head', type=int, default=16 // 4,
                    help='number of heads')
parser.add_argument('--d_model', type=int, default=768 // 3,
                    help='model dimension')
parser.add_argument('--d_condition', type=int, default=192 // 4,
                    help='condition dimension (if continuous_concat is used)')
parser.add_argument('--d_inner', type=int, default=768,
